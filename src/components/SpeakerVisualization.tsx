...
export const SpeakerVisualization = ({
  ...
  // Show only speaker (for main visualization)
  if (showOnlySpeaker) {
    return (
      <div className="space-y-6">
        ...
        {/* Device Info */}
        <Card className="p-4 space-y-3 bg-card/80 backdrop-blur-sm">
